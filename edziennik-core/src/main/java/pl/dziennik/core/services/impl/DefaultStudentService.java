...
import pl.dziennik.core.repository.StudentRepository;
...
public class DefaultStudentService implements StudentService {
    ...
    @Override
    public Set<ParentModelAbstract> getParentsByStudentEmail(String email) {
        Validate.notBlank(email);
        Set<ParentModelAbstract> parents = studentRepository.findParentsByEmail(email);
